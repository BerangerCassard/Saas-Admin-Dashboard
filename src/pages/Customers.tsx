...
import { Search, Filter, Mail, ArrowUpRight, AlertCircle, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-slate-600">Manage and view all customer accounts</p>
      </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex gap-3">
              ...
              <select
                ...
                onChange={(e) => {
                  setSelectedStatus(e.target.value as SubscriptionStatus | 'all');
                  setCurrentPage(1);
                }}
                className="px-4 py-2 border border-slate-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              >
